...
4. The `markos-web` engine renders a static web slide site and bundles a sibling CSS file that shares the entry basename when present.
...
- The recommended authoring layout is a flat pair such as `slides.md` and `slides.css`.
