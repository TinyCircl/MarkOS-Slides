...
MarkOS shared themes are reusable theme folders stored in `themes/`.
...
- A shared theme folder at `themes/<ThemeName>/`
...
2. `themes/<Theme>/README.md` defines that specific theme's public API
3. `themes/<Theme>/theme.css` implements the API
...
- `themes/<Theme>/theme.css` is the shared theme entry point
...
2. `themes/<Theme>/README.md`
3. `themes/<Theme>/theme.css`
...
- Theme file lives in `themes/` and is selected through `theme: <Name>`
...
[`themes/Clay/theme.css`](C:/Users/xuao5/Desktop/MarkOS-Slides/themes/Clay/theme.css) and [`themes/Clay/README.md`](C:/Users/xuao5/Desktop/MarkOS-Slides/themes/Clay/README.md) are the current reference implementation in this repo. This guide is the normative standard for future theme authoring work.
