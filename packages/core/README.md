...
For CLI-style local authoring, the recommended repository layout is `slides.md` plus `slides.css` as the main override layer, with optional `overrides.css` for a final incremental override layer.
